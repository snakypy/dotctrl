...
def test_cli(base):
    ...
    @assign_cli(arguments(argv=["--credits"]), "--credits")
    def credence():
        CreditsCommand().main()
...
#     dotfiles_tests(base)
#
#     @assign_cli(class_dotctrl(base).arguments(argv=["init"]), "init")
#     def init():
#         dotctrl_init(base)
...
#
#     @assign_cli(class_dotctrl(base).arguments(argv=["pull"]), "pull")
#     def pull():
#         update_config_elements(base, ".config/foo.txt", ".config/bar.txt")
...
#                 assert False
#
#     @assign_cli(class_dotctrl(base).arguments(argv=["check"]), "check")
#     def check():
#         class_dotctrl(base).check_command()
#
#     @assign_cli(class_dotctrl(base).arguments(argv=["link"]), "link")
#     def link():
...
#                 assert False
#
#     @assign_cli(class_dotctrl(base).arguments(argv=["unlink"]), "unlink")
#     def unlink():
...
#                 assert False
#
#     @assign_cli(class_dotctrl(base).arguments(argv=["restore"]), "restore")
#     def restore():
