...
# @assign_cli(
#     arguments(base()["root"], base()["home"], argv=["find", '--name=""']), "find"
# )
...
#         arguments(base["root"], base["home"], argv=["pull", "--force"])
#     )

#     LinkCommand(base["root"], base["home"]).main(
#         arguments(base["root"], base["home"], argv=["link", "--force"])
#     )

#     if not FindCommand(base["root"], base["home"]).main(
#         arguments(
#             base["root"], base["home"], argv=["find", f'--name="{elements(base)[0]}"']
#         )
#     ):
#         assert False
