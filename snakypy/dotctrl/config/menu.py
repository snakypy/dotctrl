...
USAGE:
    ...
    {__info__['executable']} restore [--e=<object> | --element=<object>] [--f | --force] [--keep-record]
    {__info__['executable']} repo (--check | --reg | --info)
...
OPTIONS:
    ...
    {FG().BLUE}--keep-record{NONE} --------------- Keep object in the {__info__["name"]} registry
                                  ({__info__["config"]}).
