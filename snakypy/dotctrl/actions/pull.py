    ...
    def main(self, arguments: dict) -> dict:
        ...
        if element:
            ...
            if isfile(file_home) and isfile(file_repo) and not force:
                ...
                # Dotctrl and in the source location. These elements are not
                # linked to the repository of the Dotctrl.
                # To replace those in the Dotctrl repository, use the --force
                # (--f) option.
